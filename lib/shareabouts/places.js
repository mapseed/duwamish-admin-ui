...
module.exports = function (options) {
  ...
  */
  places.list = function places_list (options, callback) {
    request({
  ...
  */
  ...
  places.post = function places_post (options, callback) {
    request({
  ...
  places.put = function places_put (options, callback) {
    request({
      url: host + options.username + '/datasets/' + options.slug + '/places/' + options.placeId,
      // url: host + options.username + '/datasets/' + options.slug + '/places',
      method: 'PUT',
  ...
  places.delete = function places_delete (options, callback) {
    request({
      url: host + options.username + '/datasets/' + options.slug + '/places/' + options.placeId,
      // url: host + options.username + '/datasets/' + options.slug + '/places',
      method: 'DELETE',
