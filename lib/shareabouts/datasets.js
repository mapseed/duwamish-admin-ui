...
module.exports = function (options) {
  ...
  */
   ...
   * Create a dataset
   */
  datasets.post = function datasets_post (options, callback) {
    request({
      url: host + options.username + '/datasets',
      method: 'POST',
      withCredentials: true,
   ...
   * Update a dataset
   */
  datasets.put = function datasets_put (options, callback) {
    request({
      url: host + options.username + '/datasets/' + options.slug,
      method: 'PUT',
      withCredentials: true,
   ...
   * Delete a dataset
   */
  datasets.delete = function datasets_delete (options, callback) {
    request({
      url: host + options.username + '/datasets/' + options.slug,
      method: 'DELETE',
      withCredentials: true,
